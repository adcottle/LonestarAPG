...
BEGIN
{
  ...
  $postmaster        = 'webmaster@lonestarapg.com';
  @referers          = qw(lonestarapg.com localhost);
  @allow_mail_to     = ();
  @recipients        = ();
  %recipient_alias   = (
       'servicedir'  => 'webmaster@lonestarapg.com',
       'membership'  => 'vpmembership@lonestarapg.com',
       'treasurer'   => 'treasurer@lonestarapg.com',
       'all'         => 'webmaster@lonestarapg.com,vpmembership@lonestarapg.com,treasurer@lonestarapg.com',
    );
...
From: webmaster@lonestarapg.com
Subject: LSAPG "Membership or Member Services Directory" submission

Thank you for your Lone Star Chapter APG "Membership or Member Services Directory" submission.
...
END
  ...
  <body $attr>
    <table align="center" border="0" summary="page body" width="800">
	  <tbody>
	  <tr>
		<td colspan="3"><img alt="logo" border="0" height="133" src="/images/logo.jpg" width="798" /><br />
			&nbsp;</td>
	  </tr>
      </tbody>
    </table>
...
sub success_page_footer {
  ...
  print <<END;
        <p>Copyright &copy; 2018, Lone Star Chapter, APG, All Rights Reserved.</p>
        <hr size="1" width="75%" />
        <p align="center">
           <font size="-1">
